...
class Character:
    ...
    def __init__(self, name):  # Объявляем конструктор класса.
        self.name = name
    ...
    def __str__(self):  # Новый метод базового класса.
...
class Healer(Character):
    ...
    SPECIAL_SKILL = 'Защита'   # Поместите сюда код объявленных классов.
